...
if page == "Wholesale Pricing":
    ...
    if st.session_state.wholesale_cart:
...
if page == "Admin Dashboard":
    ...
    if admin_password == "admin123":
        ...
        try:
            ...
            # -----------------------------------------------
            # ENSURE SALES TYPE EXISTS
            # -----------------------------------------------

            if "Sales_Type" in orders_df.columns:
                ...
                st.warning(
                    """
                    Sales_Type column not found.
                    New orders will populate it.
                    """
                )
